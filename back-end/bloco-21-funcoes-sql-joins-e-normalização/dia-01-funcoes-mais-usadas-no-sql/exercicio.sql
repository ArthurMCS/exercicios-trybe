...
SUM(SALARY) AS 'a soma de todos',
ROUND(AVG(SALARY), 2) AS 'media dos salarios' FROM employees;
...
SELECT JOB_ID, AVG(SALARY) FROM employees GROUP BY JOB_ID HAVING JOB_ID <> 'IT_PROG' ORDER BY AVG(SALARY) DESC;
